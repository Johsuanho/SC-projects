...
def add_data_for_name(name_data, year, rank, name):
    ...
    if name in name_data:
        for ele in name_data[name]:
            if ele == year:
                if name_data[name][ele] < rank:
                    rank = name_data[name][ele]
        year_rank[year] = rank
        name_data[name].update(year_rank)
    else:
